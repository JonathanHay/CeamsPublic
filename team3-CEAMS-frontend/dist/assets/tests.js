...
define("aouda-ceams-frontend/tests/lint/app.lint-test", [], function () {
  ...
  QUnit.test('components/committee.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/committee.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('routes/committee.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/committee.js should pass ESLint\n\n');
  });
...
define("aouda-ceams-frontend/tests/lint/templates.template.lint-test", [], function () {
  ...
  QUnit.test('aouda-ceams-frontend/templates/committee.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'aouda-ceams-frontend/templates/committee.hbs should pass TemplateLint.\n\n');
  });
  QUnit.test('aouda-ceams-frontend/templates/components/committee.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'aouda-ceams-frontend/templates/components/committee.hbs should pass TemplateLint.\n\naouda-ceams-frontend/templates/components/committee.hbs\n  2:0  error  Incorrect indentation for `{{#each}}` beginning at L2:C0. Expected `{{#each}}` to be at an indentation of 2 but was found at 0.  block-indentation\n  3:6  error  Incorrect indentation for `<div>` beginning at L3:C6. Expected `<div>` to be at an indentation of 2 but was found at 6.  block-indentation\n  5:10  error  img tags must have an alt attribute  img-alt-attributes\n');
  });
