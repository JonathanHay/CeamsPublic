define("ember-data/adapters/rest", ["exports", "ember-data/adapter", "ember-data/-private"], function (_exports, _adapter, _private) {
  "use strict";
  ...
  */
  ...
  function handleAbort(requestData, responseData) {
    ...
    return new _private.AbortError(errors);
